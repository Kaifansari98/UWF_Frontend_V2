  ...
  const cards = [
    {
      ...
      icon: BarChart2,
      color: "bg-yellow-500/15 text-yellow-600 dark:bg-yellow-500/20 dark:text-yellow-300",
    },
    {
      ...
      icon: CheckCircle,
      color: "bg-fuchsia-500/15 text-fuchsia-600 dark:bg-fuchsia-500/20 dark:text-fuchsia-300",
    },
    {
      ...
      icon: Users,
      color: "bg-blue-500/15 text-blue-600 dark:bg-blue-500/20 dark:text-blue-300",
    },
    {
      ...
      <div className="min-h-screen rounded-2xl bg-background px-10 py-8">
        ...
        <div className="relative w-14 h-14">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">{formatRoleLabel(user?.role)}</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between mt-10 mb-6">
          <div>
            <h2 className="text-xl font-semibold text-foreground">📊 Dashboard Stats</h2>
            <p className="text-sm text-muted-foreground">Track your impact and form activity over time</p>
          </div>
