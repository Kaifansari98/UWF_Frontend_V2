        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>Closed Cases</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex flex-wrap items-center gap-3 justify-between">
          ...
          <div className="flex items-center gap-2 rounded-lg border border-border bg-muted/30 p-1">
            <button
              className="flex items-center gap-2 rounded-md px-3 py-1.5 text-sm font-medium text-green-600 transition-colors hover:bg-green-500/10 hover:text-green-500 dark:text-green-400 dark:hover:bg-green-500/15"
              onClick={async () => {
                try {
